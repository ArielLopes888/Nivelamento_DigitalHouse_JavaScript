...
// Escreva uma função transformaParaMaiusculo(palavras). Essa função recebe como parâmetro um
//  array de palavras. Ela deve retornar um array com a versão MAIÚSCULA de todas as palavras 
...
console.log(transformaParaMaiusculo([])) 