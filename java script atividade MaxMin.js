...
// Sua função deve retornar um array onde o primeiro elemento é o menor dos parâmetros da função maxmin e o
//  segundo elemento é o maior dos parâmetros da função maxmin.
